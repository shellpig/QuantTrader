...
export function useP11DividendHistory(symbol: string | null, market: Market, count = 5) {
  const key = !symbol || market !== "tw" || DISABLE_FETCH ? null : `p11/dividend/${market}/${symbol}/${count}`;
